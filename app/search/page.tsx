...
export const metadata: Metadata = {
    title: "2026流量卡搜索对比 | 19元29元大流量卡推荐 5G手机卡在线办理 - 流量派",
    description:
...
export default async function SearchPage() {
    ...
    /** 站点基础 URL */
    const siteUrl = process.env.NEXT_PUBLIC_SITE_URL || "https://www.llpai.com";
    ...
    const jsonLd = {
        ...
        "url": `${siteUrl}/search`,
        "isPartOf": { "@type": "WebSite", "name": "流量派", "url": siteUrl },
        "potentialAction": {
            "@type": "SearchAction",
